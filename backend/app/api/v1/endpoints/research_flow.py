...
【重要规则 - 产品定位】
如果用户的研究需求中涉及任何产品或服务，你必须在输出中明确标注：
- 产品名称：具体的产品名（如"iPhone 15 Pro"、"特斯拉Model 3"）
- 品牌/公司：所属品牌或公司（如"苹果"、"特斯拉"）
- 精准定位：确保能唯一识别该产品，避免模糊描述

例如：用户说"研究某手机的用户体验"，你必须追问或假设具体品牌型号，如"华为Mate系列手机"。
...
1. 研究目标（1-2句话）
2. 【产品定位】如果涉及产品，明确写出：产品名称、品牌/公司、具体型号（如适用）
3. 目标人群画像描述
4. 访谈框架（3-4个阶段，每阶段2-3个核心问题）
5. 初始假设（3-5个基于现有认知的假设）
...
请根据调整要求更新研究框架，输出完整的方案（保持原有结构，确保产品定位清晰）。"""
...
任务：
请生成 1 组适合在小红书搜索的中文搜索词。

要求：
1. 搜索词必须像真实用户会搜索或会写出来的表达
2. 优先覆盖这些调研维度：
- 痛点/问题
- 使用场景
- 购买决策
...
- 真实体验
- 吐槽/避坑
3. 搜索词要贴近原始产品信息所属的品类和场景，但不要照搬品牌文案
4. 不要输出空泛词，例如：
- 健康产品推荐
- 提升生活品质
- 科技改变生活
...
- 居家好物分享
5. 不要只写职业、年龄、性别等人口属性
6. 每个关键词长度控制在 8 到 22 个字，尽量自然、口语化
7. 所有关键词中至少满足：
- 2 个偏痛点/问题表达
- 1 个偏使用场景
- 1 个人设相关关键词
